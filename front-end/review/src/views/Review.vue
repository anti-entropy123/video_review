...
<!--              <a-switch checked-children="全体批注" un-checked-children="禁止批注" />-->
    ...
    <div class="left">
      <div class="videos">
        ...
        <div   :style="`width:${this.videoSize[0]}px;height:${this.videoSize[1]}px;position: absolute`" >
          <img v-cloak v-if="isCheckComment==true" v-bind:src="currentImageUrl"  style="width: 100%;">
        </div>
        <div class="mask" v-if="canControl==false" :style="`width:${this.videoSize[0]}px;height:${this.videoSize[1]}px;position: absolute`">
          ...
          <li>
            <div class="discuss">
              ...
              <div class="dicussBody" style="clear:both">
                <div style="cursor:pointer;color:#4189d3" class="discussTime" @click="toPosition(comment.position,comment.imageUrl,index)">{{comment.time}}</div>
