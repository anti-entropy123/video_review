...
<!--        <div class="tools">-->
<!--          &lt;!&ndash;        <button @click="saveImg">生成图片</button>&ndash;&gt;-->
...
<!--                &lt;!&ndash;                <div v-if="comment.fromName==this.userName" @click="deleteComment(comment.commentId)">删除</div>&ndash;&gt;-->
<!--              </div>-->
<!--            </div>-->
<!--          </li>-->
<!--        </ul>-->
